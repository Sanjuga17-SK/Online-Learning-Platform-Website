        ...
        >
            ...
            <div className="relative z-10 w-full max-w-md bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl text-white">
                    ...
                    <div className="flex items-center justify-between pt-1">
                        <label className="flex items-center space-x-2 cursor-pointer group">
                            <div
                                ...
                                className={`relative flex items-center justify-center w-4 h-4 rounded border transition-all group-active:scale-95 ${rememberMe ? 'bg-indigo-500 border-indigo-500' : 'bg-white/5 border-white/30'}`}
                            >
                                {rememberMe && (
                            ...
                            <span className="text-xs text-white/90 group-hover:text-white transition-colors" onClick={() => setRememberMe(!rememberMe)}>Remember me</span>
                        </label>
                        <button type="button" onClick={() => navigate('/forgot')} className="text-xs text-white/90 hover:text-white transition-colors">Forgot password?</button>
                    </div>
                ...
                <div className="mt-8 text-center text-xs text-white/70">
                    Don't have an account? <button onClick={() => navigate('/register')} type="button" className="text-white font-medium hover:underline">Sign Up</button>
                </div>
            </div>
        </div>
    );
